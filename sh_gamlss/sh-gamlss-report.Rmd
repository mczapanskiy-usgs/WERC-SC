...
5. SI, SICHEL, and PIG distributions tend to perform the best (which makes sense, they're all closely related). The geographic models outperform their oceanographic counterparts in every month but June.
```{r best_fits}
model.rankings %>%
  group_by(Month) %>%
