...
plot(Fish_poly_42,add=TRUE,col="light green")
...
Fish_poly_42 <- readOGR("/Users/henry/Documents/Work/Projects/BFAL NFWF Oikonos/Data/Fish_poly_42","Fish_poly_42") # clipper comes in as  GS84
...
joined<-(ldply(over(grid.clip,Redis.DF.sp,returnList=TRUE), rbind))
# head(joined)
