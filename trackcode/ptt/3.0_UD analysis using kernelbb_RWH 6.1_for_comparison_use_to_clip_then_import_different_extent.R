...
# first check to see if the tracks were segemented
if (paste(clipperName,'Buffer_id2',sep='') %in% names(ptt)=="FALSE") {
  ...
  # get frequncies from the segemnts - paste(clipperName,'Buffer_id2',sep='')
